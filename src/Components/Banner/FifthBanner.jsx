...
const FIfthBanner = () => {
  return (
    <div>
      <div className="bg-gradient-to-b from-[#EDEFFF00] to-[#EDEFFF] py-32 px-5 flex flex-col gap-10">
        <div className="flex flex-col gap-4">
          <div className="text-3xl font-bold">Why choose Zwilt?</div>
          <div className="opacity-80">
            We take complex hiring processes - and simplify them. Connecting you
            to the world&apos;s highly qualified talent pool.
          </div>
        </div>
        <div className="h-400px bg-white p-5 rounded-xl flex flex-col gap-4">
