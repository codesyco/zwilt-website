  ...
  return (
    <div>
      <div className='flex flex-col gap-5 p-5 items-center justify-center'>
        ...
        <div className='h-fit'>
            <div className='h-[150px] bg-[#EDEFFF] parallelogram-clip-semi-sections flex place-items-center p-5'>
                <div className='text-transparent bg-clip-text bg-gradient-to-b from-[#A387D1] to-[#D1C4E275] text-8xl font-semibold place-self-start'>1</div>
                ...
                <div className=''>
                  <img src={banner} alt="" className='h-[700px] w-[600px]' />
                </div>
            </div>
            <div className='h-[150px] bg-[#FFF7E1] parallelogram-clip-semi-sections flex place-items-center p-5'>
                <div className='text-transparent bg-clip-text bg-gradient-to-b from-[#FFBE2EC2] to-[#FFBE2E00] text-8xl font-semibold place-self-start'>2</div>
                <div className='flex flex-col gap-2'>
                    <div className='flex flex-col gap-2'>
            ...
            <div className='h-[150px] bg-[#F3F3F3] parallelogram-clip-semi-sections flex place-items-center p-5'>
                <div className='text-transparent bg-clip-text bg-gradient-to-b from-[#000000CC] to-[#00000029] text-8xl font-semibold place-self-start'>3</div>
                <div className='flex flex-col gap-2'>
                    <div className='flex flex-col gap-2'>
                        <div className='text-xs font-bold'>Find your next star performer.</div>
                        <div className='text-[8px] opacity-70'>Explore the vast Zwilt marketplace to find the candidate that meets your needs.</div>
